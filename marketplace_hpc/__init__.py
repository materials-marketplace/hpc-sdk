...
class HpcGatewayApp:
    def __init__(self, app_id, marketplace_host_url=None, access_token=None, **kwargs):
        self._app = get_app(app_id, marketplace_host_url, access_token, **kwargs)

    def status(self):
        return self._app.heartbeat()
